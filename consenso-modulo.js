...
window.ConsensoModulo = (function () {
  ...
  const T = {
    it: {
      ...
      subtitle: 'Per la funzione «Classe» dell\'app Tuffo Italiano',
      ...
      consentP: 'Autorizzo la raccolta e il trattamento dei seguenti dati di mio figlio/mia figlia tramite la funzione Classe dell\'app Tuffo Italiano, per la finalità di seguimento didattico da parte del suo insegnante di italiano:',
      dataItems: [
      ...
      controllerP: 'Titolare del trattamento: l\'insegnante/scuola. Responsabile del trattamento ai sensi dell\'art. 28 GDPR: Thuis Italiaans (Alessio Are, Ede, Paesi Bassi), contattabile a thuisitaliaans@gmail.com.',
    ...
    en: {
      ...
      subtitle: 'For the "Classe" feature of the Tuffo Italiano app',
      ...
      consentP: 'I authorise the collection and processing of the following data about my child through the Classe feature of the Tuffo Italiano app, for the purpose of educational monitoring by their Italian teacher:',
      dataItems: [
      ...
      controllerP: 'Data controller: the teacher/school. Data processor under Art. 28 GDPR: Thuis Italiaans (Alessio Are, Ede, Netherlands), contactable at thuisitaliaans@gmail.com.',
    ...
    nl: {
      ...
      subtitle: 'Voor de functie "Classe" van de app Tuffo Italiano',
      ...
      consentP: 'Ik geef toestemming voor het verzamelen en verwerken van de volgende gegevens over mijn kind via de functie Classe van de app Tuffo Italiano, met als doel didactische opvolging door de docent Italiaans:',
      dataItems: [
      ...
      controllerP: 'Verwerkingsverantwoordelijke: de docent/school. Verwerker in de zin van art. 28 AVG: Thuis Italiaans (Alessio Are, Ede, Nederland), bereikbaar op thuisitaliaans@gmail.com.',
    ...
    de: {
      ...
      subtitle: 'Für die Funktion „Classe" der App Tuffo Italiano',
      ...
      hSection2: 'Erklärung',
      consentP: 'Ich erlaube die Erhebung und Verarbeitung folgender Daten meines Kindes durch die Funktion Classe der App Tuffo Italiano, zum Zwecke der didaktischen Begleitung durch die Italienischlehrperson:',
      dataItems: [
      ...
      controllerP: 'Verantwortlicher: die Lehrperson/Schule. Auftragsverarbeiter gemäß Art. 28 DSGVO: Thuis Italiaans (Alessio Are, Ede, Niederlande), erreichbar unter thuisitaliaans@gmail.com.',
    ...
    fr: {
      ...
      subtitle: 'Pour la fonction « Classe » de l\'application Tuffo Italiano',
      ...
      consentP: 'J\'autorise la collecte et le traitement des données suivantes concernant mon enfant via la fonction Classe de l\'application Tuffo Italiano, pour le suivi pédagogique par son enseignant d\'italien :',
      dataItems: [
      ...
      controllerP: 'Responsable du traitement : l\'enseignant/école. Sous-traitant au sens de l\'art. 28 RGPD : Thuis Italiaans (Alessio Are, Ede, Pays-Bas), contactable à thuisitaliaans@gmail.com.',
    ...
    es: {
      ...
      subtitle: 'Para la función «Classe» de la app Tuffo Italiano',
      ...
      consentP: 'Autorizo la recogida y el tratamiento de los siguientes datos de mi hijo/a a través de la función Classe de la app Tuffo Italiano, con la finalidad de seguimiento didáctico por parte de su docente de italiano:',
      dataItems: [
      ...
      controllerP: 'Responsable del tratamiento: el docente/escuela. Encargado del tratamiento en el sentido del art. 28 RGPD: Thuis Italiaans (Alessio Are, Ede, Países Bajos), contactable en thuisitaliaans@gmail.com.',
    ...
    pt: {
      ...
      subtitle: 'Para a funcionalidade «Classe» da app Tuffo Italiano',
      ...
      consentP: 'Autorizo a recolha e o tratamento dos seguintes dados sobre o meu filho/a minha filha através da funcionalidade Classe da app Tuffo Italiano, para efeito de acompanhamento didático pelo seu professor de italiano:',
      dataItems: [
      ...
      controllerP: 'Responsável pelo tratamento: o professor/escola. Subcontratante nos termos do art. 28 RGPD: Thuis Italiaans (Alessio Are, Ede, Países Baixos), contactável em thuisitaliaans@gmail.com.',
    ...
    ro: {
      ...
      subtitle: 'Pentru funcția «Classe» a aplicației Tuffo Italiano',
      ...
      consentP: 'Autorizez colectarea și prelucrarea următoarelor date despre copilul meu prin funcția Classe a aplicației Tuffo Italiano, în scopul monitorizării didactice de către profesorul său de italiană:',
      dataItems: [
      ...
      controllerP: 'Operator: profesorul/școala. Persoană împuternicită conform art. 28 GDPR: Thuis Italiaans (Alessio Are, Ede, Țările de Jos), contactabil la thuisitaliaans@gmail.com.',
    ...
    sq: {
      ...
      subtitle: 'Për funksionin «Classe» të aplikacionit Tuffo Italiano',
      ...
      hSection2: 'Deklaratë',
      consentP: 'Autorizoj mbledhjen dhe përpunimin e të dhënave të mëposhtme për fëmijën tim përmes funksionit Classe të aplikacionit Tuffo Italiano, për qëllime të ndjekjes didaktike nga mësuesi/mësuesja e italishtes:',
      dataItems: [
      ...
      controllerP: 'Kontrollues i të dhënave: mësuesi/shkolla. Përpunues i të dhënave sipas nenit 28 të GDPR: Thuis Italiaans (Alessio Are, Ede, Vendet e Ulëta), i kontaktueshëm në thuisitaliaans@gmail.com.',
    ...
    uk: {
      ...
      subtitle: 'Для функції «Classe» додатка Tuffo Italiano',
      ...
      hSection2: 'Заява',
      consentP: 'Дозволяю збір і обробку таких даних про мою дитину через функцію Classe додатка Tuffo Italiano з метою дидактичного супроводу її вчителем італійської мови:',
      dataItems: [
      ...
      controllerP: 'Контролер даних: вчитель/школа. Обробник за ст. 28 GDPR: Thuis Italiaans (Alessio Are, Ede, Нідерланди), контакт: thuisitaliaans@gmail.com.',
    ...
    zh: {
      title: '家长同意书',
      subtitle: '适用于 Tuffo Italiano 应用的"Classe"功能',
      ...
      fBirth: '学生的出生日期',
      hSection2: '声明',
      consentP: '我授权通过 Tuffo Italiano 应用的 Classe 功能收集和处理关于我孩子的以下数据，用于其意大利语老师的教学跟踪：',
      dataItems: [
        '所选用户名（不一定是真实姓名）；',
        '所达到的意大利语等级（A1–C2）；',
        '在应用中完成的练习数量和类型；',
      ...
      controllerP: '数据控制者：老师/学校。GDPR 第 28 条意义上的数据处理者：Thuis Italiaans（Alessio Are，荷兰埃德市），联系方式：thuisitaliaans@gmail.com。',
    ...
    ar: {
      ...
      subtitle: 'لميزة «Classe» في تطبيق Tuffo Italiano',
      ...
      hSection2: 'إقرار',
      consentP: 'أُصرّح بجمع ومعالجة البيانات التالية المتعلقة بطفلي عبر ميزة Classe في تطبيق Tuffo Italiano، لغرض المتابعة التربوية من قِبل معلّم اللغة الإيطالية:',
      dataItems: [
      ...
      controllerP: 'المسؤول عن المعالجة: المعلّم/المدرسة. المُعالِج بمعنى المادة 28 من GDPR: Thuis Italiaans (Alessio Are، Ede، هولندا)، البريد: thuisitaliaans@gmail.com.',
    ...
    bn: {
      ...
      subtitle: 'Tuffo Italiano অ্যাপের "Classe" ফিচারের জন্য',
      ...
      hSection2: 'ঘোষণা',
      consentP: 'আমি আমার সন্তানের নিম্নলিখিত তথ্য Tuffo Italiano অ্যাপের Classe ফিচারের মাধ্যমে সংগ্রহ ও প্রক্রিয়াকরণের অনুমতি দিচ্ছি, যাতে তার ইতালীয় শিক্ষক শিক্ষামূলক পর্যবেক্ষণ করতে পারেন:',
      dataItems: [
      ...
      controllerP: 'ডাটা কন্ট্রোলার: শিক্ষক/স্কুল। GDPR-এর ২৮ অনুচ্ছেদ অনুযায়ী ডাটা প্রসেসর: Thuis Italiaans (Alessio Are, Ede, নেদারল্যান্ডস), যোগাযোগ: thuisitaliaans@gmail.com।',
    ...
    tl: {
      ...
      subtitle: 'Para sa tampok na "Classe" ng app na Tuffo Italiano',
      ...
      consentP: 'Pinapahintulutan ko ang pagkolekta at pagpoproseso ng sumusunod na datos tungkol sa aking anak sa pamamagitan ng tampok na Classe ng app na Tuffo Italiano, para sa layunin ng edukasyonal na pagsubaybay ng kanyang guro ng Italyano:',
      dataItems: [
      ...
      controllerP: 'Data controller: ang guro/paaralan. Data processor sa ilalim ng Art. 28 GDPR: Thuis Italiaans (Alessio Are, Ede, Netherlands), makokontak sa thuisitaliaans@gmail.com.',
    ...
    ti: {
      ...
      subtitle: 'ናይ Tuffo Italiano ኣፕ ናይ «Classe» ተግባር',
      ...
      hSection2: 'መግለጺ',
      consentP: 'ብመንገዲ ናይ Tuffo Italiano ኣፕ Classe ተግባር፣ ንመምህር ጣልያንኛ ናይ ትምህርታዊ ክትትል ንምግባር፣ ናይ ወደይ/ጓለይ ዝስዕቡ ሓበሬታታት ንምእካብ ከምኡ\'ውን ንምሕዛእ ይፈቅድ ኣለኹ፦',
      dataItems: [
      ...
      controllerP: 'ናይ ኣቓልቦታት ተቖጻጻሪ፦ መምህር/ቤት ትምህርቲ። ብዓንቀጽ 28 ናይ GDPR ናይ ኣቓልቦታት ኣገልጋሊ፦ Thuis Italiaans (Alessio Are, Ede, ኔዘርላንድ)፣ ብ thuisitaliaans@gmail.com ክረኸብ ይኽእል።',
